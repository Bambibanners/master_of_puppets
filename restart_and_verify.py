...
def restart_and_verify():
    ...
    try:
        ...
        client.exec_command("cd master_of_puppets && podman-compose -f compose.server.yaml down")
        stdin, stdout, stderr = client.exec_command("cd master_of_puppets && podman-compose -f compose.server.yaml up -d")
