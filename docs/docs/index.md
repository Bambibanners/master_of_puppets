...
**Axiom** is a self-hosted orchestration platform for managing distributed agent nodes — deploy jobs, schedule tasks, and monitor your fleet from a central control plane.

## What it does

- **Node management** — Axiom Nodes self-enroll via mTLS and poll for work. No inbound firewall rules needed.
...
```
Axiom Orchestrator (Control Plane)  ←── mTLS ──→  Axiom Nodes
...
| Push jobs from the CLI | [axiom-push CLI](feature-guides/axiom-push.md) |
